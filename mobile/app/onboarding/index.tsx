...
import { View, Text, FlatList, useWindowDimensions, Dimensions } from "react-native";
...
const ONBOARDING_DATA = [
    {
        id: "1",
        title: "Trust No One",
        description: "In ITSU, deception is your strongest weapon. Work together to survive, or betray everyone for the ultimate prize.",
        Icon: Ghost,
    },
    {
        id: "2",
        title: "Stake Your Claim",
        description: "Connect your wallet and stake SOL to enter the arena. The survivors split the entire pool.",
        Icon: Wallet,
    },
    {
        id: "3",
        title: "Survive the Night",
        description: "Chat with players, cast your votes, and stay alive until the sun rises to claim your winnings.",
        Icon: Shield,
    },
];
        ...
        <SafeAreaView className="flex-1 bg-black relative">
            ...
            <Animated.FlatList
                ...
                renderItem={({ item, index }) => (
                    <OnboardingItem item={item} index={index} scrollX={scrollX} width={width} />
                )}
            />
...
function OnboardingItem({ item, index, scrollX, width }: any) {
    ...
    return (
        <View style={[{ width }]} className="flex-1 items-center justify-center p-6 pb-40">
