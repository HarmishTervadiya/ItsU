...
export default function GameHomeScreen() {
  ...
  }, [retriveUserStats, retriveUserData]);
  ...
  const onPracticeGame = useCallback(async () => {
      ...
      >
          ...
          <View className="max-w-72 flex-row items-center gap-3 bg-panel p-2 pr-4 rounded-full border-4 border-[#12121A] shadow-md">
            ...
            <View>
              ...
              <Text
                ...
                lineBreakMode="clip"
                className="text-wrap text-sm font-black text-white leading-none uppercase"
              >
                {user?.name || "PLAYER"}
              </Text>
            </View>
        ...
        >
          ...
          <View className="relative shadow-2xl">
            ...
            <View className="absolute inset-x-0 bottom-0 top-3 rounded-[32px] bg-primary-dark" />

            <View className="relative rounded-[32px] p-6 border-b-8 overflow-hidden bg-primary border-primary-dark">
              ...
              <View className="items-center z-10">
                <Text
                  className="w-full text-center text-4xl font-black text-white italic uppercase tracking-tighter"
                  style={{
                ...
                {isMatchmakingLoading ? (
                  ...
                  <>
                    ...
                    <Text className="text-[10px] text-white/60 font-bold mt-1 uppercase w-full text-right">
                      Queue: Fast
                    </Text>
                  </>
                )}
        ...
        <View className="flex-row gap-3 mb-8 z-10">
          ...
          <View className="flex-1 bg-[#3B3E5B] border-4 border-[#12121A] rounded-2xl p-3 flex-row items-center gap-3 shadow-[4px_4px_0_0_black]">
            ...
            <View className="flex-1">
              <Text className="w-full text-[10px] font-black text-slate-400 uppercase">
                Wins
              </Text>
              <Text className="w-full text-xl font-black text-white">
                {stats.totalWins}
              </Text>
            </View>
          </View>
        ...
        <View className="flex-row flex-wrap justify-between gap-y-4 z-10">
          ...
          >
            {isPracticeLoading ? (
              ...
              <>
                ...
                <Text className="w-full font-black text-white text-lg mt-1">
                  Practice
                </Text>
                <View className="bg-yellow-500/20 px-2 py-0.5 rounded-full mt-1">
                  <Text className="w-full text-[10px] font-bold text-yellow-300">
                    No Risk
                  </Text>
                </View>
              </>
          ...
          >
            ...
            <Text className="w-full text-xs font-bold text-slate-400 mt-1">
              Past kills
            </Text>
          </TouchableOpacity>
          ...
          >
            <View className="flex-row items-center gap-4">
              ...
              <View className="w-full">
                <Text className="w-full font-black text-white text-lg">
                  How to Play
                </Text>
                <Text className="w-full text-xs font-bold text-slate-400">
          ...
          <View className="w-full mt-2">
            <GameButton
              variant="primary"
              icon={<Siren size={24} color="white" />}
