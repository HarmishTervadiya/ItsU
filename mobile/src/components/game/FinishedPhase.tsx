...
export const FinishedPhase: React.FC<FinishedPhaseProps> = ({
  ...
  return (
    <View
      className="absolute inset-0 z-50 bg-[#0a0a10]/95 flex-col items-center justify-center"
    ...
    >
      ...
      {winnerRole && (
        <Text
          className={`text-xl font-black uppercase tracking-widest text-center mb-2 ${winnerRole === "WOLF" ? "text-red-500" : "text-primary"}`}
        >
          {winnerRole}S WIN
        </Text>
      )}
      ...
      <Text className="text-slate-400 text-sm font-bold text-center mb-8">
      ...
      >
        <Text className="w-full text-center text-wrap text-sm font-black text-white uppercase tracking-widest">
          Return to Lobby
        </Text>
      </TouchableOpacity>
    </View>
